<?php
	...
	$query="insert into penilaianta values('$kodeNilai','$noSeminar','$nilaiPembimbing1','$nilaiPembimbing2','$nilaiPenguji','$nilaiKoordinator', '$rerataNilai','$mutuNilai','$nimMhsw')";
